...
import 'package:pmsn_p6/Firebase/productos_firebase.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
          child: const Icon(Icons.store), onPressed: () => showModal(context)),
      appBar: AppBar(
        title: const Text("Productos de firebase"),
      ),
      body: StreamBuilder(
        stream: productsFirebase
            .consultar(), //Esto hace que nos suscribamos a la coleccion, cuando ocurra un cambio, se actualizará todo automaticamente
    ...
    final btnAgregar = ElevatedButton.icon(
      onPressed: () {
        productsFirebase.insertar({
          ...
          'imagen':
              'https://www.soriana.com/dw/image/v2/BGBD_PRD/on/demandware.static/-/Sites-soriana-grocery-master-catalog/default/dw931c9e97/images/product/0041789001864_A.jpg?sw=445&sh=445&sm=fit'
        });
      },
